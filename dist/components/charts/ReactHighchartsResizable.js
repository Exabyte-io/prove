...
export class ReactHighchartsResizable extends React.Component {
    ...
    render() {
        ...
        return (_jsx(StyledDiv, { className: "resizable-container", onClick: (e) => {
            ...
            }, children: _jsx(HighchartsReact, { resizable: false, highcharts: Highcharts, options: newProps.config, containerProps: newProps.domProps }) }));
    }
}
