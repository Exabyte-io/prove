...
export type PropertyWithConfig = PropertyName.pressure | PropertyName.total_force | PropertyName.total_energy | PropertyName.surface_energy | PropertyName.fermi_energy | PropertyName.reaction_energy_barrier | PropertyName.zero_point_energy | PropertyName.atomic_constraints | PropertyName.jupyter_notebook_endpoint | PropertyName.is_relaxed | PropertyName.valence_band_offset;
/**
